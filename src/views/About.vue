<template>
    ...
    <div class="flex flex-row items-center justify-start my-4">
      <div class="w-12 h-12 flex flex-col justify-center">
        <img src="@/assets/sahar.svg" class="h-10 block mx-auto" alt="sahar.design">
      </div>
      <p class="ml-6 mb-0">
    ...
    <div class="flex flex-row items-center justify-start my-4">
      <div class="w-12 h-12 flex flex-col justify-center">
        <img src="@/assets/tom.svg" class="h-10 block mx-auto" alt="ttntm.me">
      </div>
      <p class="ml-6 mb-0">
